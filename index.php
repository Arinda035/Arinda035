...
<div class="card-header"><br>
    <center><img src="create.jpg" class="img-rounded" alt="Cinque Terre" width="150" height="150"></center><br>
</div>
<h1><font color = "black"> สร้างบัญชีใหม่ </font></h1>
...
<br>
<div>
  <input type="submit" class= "form-control" name="submit" value="สมัคร">
</div>
</form>
</CENTER> 
